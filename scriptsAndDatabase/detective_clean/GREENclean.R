...
dbGetQuery(con, "SELECT COUNT(*) FROM textTable WHERE Type='sentence'AND label='0'")
dbGetQuery(con, "SELECT COUNT(*) FROM textTable WHERE Type='paragraph'AND label='0'")
...
dbGetQuery(con, "SELECT COUNT(*) FROM textTable")
