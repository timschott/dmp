...
life.para.matrix <- cbind(life.title, life.para.type, life.para.id, life.paragraphs)
...
life.sents.matrix <- cbind(life.title, life.sents.type, life.sents.id, life.sents)
